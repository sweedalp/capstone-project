/**
 * TrainerNotifications — reusable notification bell for all trainer headers.
            ...
            {notifications.length === 0 ? (
              ...
              notifications.map(n => (
                ...
                >
                  ...
                  {!n.is_read && <span className="size-2 bg-blue-500 rounded-full flex-shrink-0 mt-1.5"></span>}
                </button>
              ))
            )}
          </div>
